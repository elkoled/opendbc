...
static safety_config psa_init(uint16_t param) {
  ...
  static RxCheck psa_rx_checks[] = {
    {.msg = {{PSA_HS2_DAT_MDD_CMD_452, PSA_ADAS_BUS, 6, .max_counter = 15U, .frequency = 20U}, { 0 }, { 0 }}},                       // cruise state
    {.msg = {{PSA_HS2_DYN_ABR_38D, PSA_CAM_BUS, 8, .max_counter = 15U, .frequency = 25U}, { 0 }, { 0 }}},                           // speed
    ...
    {.msg = {{PSA_DYN_CMM, PSA_CAM_BUS, 8, .ignore_checksum = true, .ignore_counter = true,  .frequency = 100U}, { 0 }, { 0 }}},       // gas pedal
