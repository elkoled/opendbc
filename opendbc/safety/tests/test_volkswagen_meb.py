...
class TestVolkswagenMebLongSafety(TestVolkswagenMebSafetyBase):
  TX_MSGS = [[MSG_HCA_03, 0], [MSG_LDW_02, 0], [MSG_ACC_18, 0], [MSG_MEB_ACC_01, 0],
             [MSG_EA_01, 0], [MSG_EA_02, 0], [MSG_KLR_01, 0], [MSG_KLR_01, 2], [MSG_TA_01, 0]]
  FWD_BLACKLISTED_ADDRS = {0: [MSG_KLR_01], 2: [MSG_HCA_03, MSG_LDW_02, MSG_ACC_18, MSG_MEB_ACC_01, MSG_EA_02, MSG_TA_01]}
  RELAY_MALFUNCTION_ADDRS = {0: (MSG_HCA_03, MSG_LDW_02, MSG_ACC_18, MSG_MEB_ACC_01, MSG_EA_02, MSG_TA_01), 2: (MSG_KLR_01,)}
  ...
  def test_accel_safety_check(self):
    for controls_allowed in (True, False):
      for accel in np.concatenate((np.arange(MIN_ACCEL - 1, MAX_ACCEL + 1, 0.05), [0.0, INACTIVE_ACCEL])):
        ...
        # accel=0 (override) is allowed whenever controls are allowed; otherwise within range.
