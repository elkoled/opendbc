...
class CarState(CarStateBase):
  def update(self, can_parsers) -> structs.CarState:
    ...
    # steering wheel
    ret.steeringAngleDeg = cp_cam.vl['STEERING_ALT']['ANGLE'] # EPS
    ret.steeringRateDeg = cp_cam.vl['STEERING_ALT']['RATE'] * (2 * cp_cam.vl['STEERING_ALT']['RATE_SIGN'] - 1) # convert [0,1] to [-1,1] EPS: rot. speed * rot. sign
