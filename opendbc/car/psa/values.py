...
class CarControllerParams:
  ...
  ANGLE_RATE_LIMIT_UP = AngleRateLimit(speed_bp=[0., 5., 15.], angle_v=[50., 3.2, .6]) # TODO: refine limits
  ANGLE_RATE_LIMIT_DOWN = AngleRateLimit(speed_bp=[0., 5., 15.], angle_v=[50., 14., 1.6]) # TODO: refine limits
