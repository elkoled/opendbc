...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate: CAR, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    if ret.flags & VolkswagenFlags.PQ:
      ...
      ret.dashcamOnly = is_release  # Release support needs lateral safety validation
    ...
    if ret.flags & VolkswagenFlags.PQ or ret.flags & VolkswagenFlags.MLB:
      ...
      # MEB uses angle control + vehicle-model-based limits in carcontroller, no PID tuning.
    else:
