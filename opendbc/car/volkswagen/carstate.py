...
class CarState(CarStateBase):
  ...
  def update_meb(self, pt_cp, cam_cp, ext_cp) -> structs.CarState:
    ...
    # Update gas, brakes, and parking brake.
    ...
    # Update button states for turn signals and ACC controls
  ...
  def get_can_parsers_meb(CP):
    pt_messages = [
      ("Blinkmodi_02", 1),  # From BCM, sent at 1Hz idle / 50Hz active
    ]
    cam_messages = []
    alt_messages = []

    if CP.enableBsm:
      cam_messages += [("MEB_Side_Assist_01", 20)]
