...
def apply_std_curvature_limits(apply_curvature: float, apply_curvature_last: float, v_ego: float, curvature: float,
  ...
  # Lateral acceleration: average road roll for safety without true roll
  # (allows up to ~3.6 m/s^2, suited for curvature values with positive offsets without true loss)
